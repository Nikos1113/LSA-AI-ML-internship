# UK Internship: Machine Learning & Statistical Analysis

This repository contains the core technical tasks developed during my internship in the UK, focusing on predictive modeling, neural networks, and statistical validation.

## 🚀 Projects Overview

### 1. Predictive Modeling Comparison
A comprehensive study comparing classical Machine Learning algorithms with Deep Learning approaches.
...
## 📈 Key Findings
* Decision Trees handled non-linear outliers better than Linear Regression in this specific dataset.
* Hypothesis testing reduced the feature set, leading to faster training times.
